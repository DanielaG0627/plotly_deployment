...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var samplesArray = samplesArray.filter(sampleObj => sampleObj.id == sample);
    ...
    //var yticks = 
    yticks = otuIds.slice(0,10).map(id => "OTU " + id).reverse();
    ...
    // 2. Create a variable that holds the first sample in the 
    //metadata array.
